...
{
    public class SpiritHealOrDrain : SRBehaviour, ControllerCollisionListener
    {
        ...
        public void TryToHealOrDrain(GameObject gameObj)
        {
            ...
            {
                DeathHandler.Kill(gameObj, DeathHandler.Source.SLIME_ATTACK, base.gameObject, "SpiritHealOrDrain.TryToHealOrDrain");
            }
        }
